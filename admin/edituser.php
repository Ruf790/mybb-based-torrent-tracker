...
function renderPermissionsTab(): string
{
    ...
    if ($db->num_rows($query) > 0) 
	{
        ...
        $cancomment = $permresults['cancomment'] == 1 ? 'yes' : 'no';
        $canupload = $permresults['canupload'] == 1 ? 'yes' : 'no';
        $candownload = $permresults['candownload'] == 1 ? 'yes' : 'no';
    } 
	else 
	{
        $cancomment = $canupload = $candownload = 'yes';
    }
...
function updateUserPermissions(): void
{
    ...
    $updateperm = [
        'cancomment' => ($_POST['cancomment'] == 'yes' ? 1 : 0),
        'canupload' => ($_POST['canupload'] == 'yes' ? 1 : 0),
