...
<div class="modal fade" id="universalImageModal" tabindex="-1">
    <div class="modal-dialog modal-fullscreen m-0">
     ...
     class="rounded"
     src=""
     style="max-width: 1000px; max-height: 1000px; width: auto; height: auto; object-fit: contain; cursor: pointer;">
            </div>
