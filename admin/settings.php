...
$r_verification       = $settings['r_verification']         ?? 'yes';
$maxusers             = $settings['maxusers']               ?? '0';
$coppa                = $settings['coppa']                  ?? 'disabled';
...
// CLEANUP
$ai                    = $settings['ai']                    ?? 'no';
$autoinvitetime        = $settings['autoinvitetime']        ?? '30';
