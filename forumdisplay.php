...
if($browsingthisforum != 0)
{
	...
	$sql = "
    SELECT
        s.ip, s.uid, u.username, s.time, u.invisible, u.usergroup, u.displaygroup
    FROM
        sessions s
...
if($has_announcements == true)
{
	...
	$sql_part = build_parent_list($fid, "fid", "OR", $parentlist);
$time = TIMENOW;
