...
class DefaultPage
{
	...
	function output_header($title="")
	{
		...
		echo "	<link rel=\"stylesheet\" href=\"main.css?ver=1813\" type=\"text/css\" />\n";
		echo "	<link rel=\"stylesheet\" href=\"modal.css?ver=1813\" type=\"text/css\" />\n";
		...
		echo "	<script type=\"text/javascript\" src=\"scripts/jquery.js?ver=1823\"></script>\n";
		echo "	<script type=\"text/javascript\" src=\"scripts/jquery.plugins.min.js?ver=1821\"></script>\n";
		echo "	<script type=\"text/javascript\" src=\"scripts/general.js?ver=1821\"></script>\n";
		echo "	<script type=\"text/javascript\" src=\"admincp.js?ver=1821\"></script>\n";
		echo "	<script type=\"text/javascript\" src=\"tabs.js\"></script>\n";

		echo "	<link rel=\"stylesheet\" href=\"jqueryui/css/redmond/jquery-ui.min.css\" />\n";
		echo "	<link rel=\"stylesheet\" href=\"jqueryui/css/redmond/jquery-ui.structure.min.css\" />\n";
		echo "	<link rel=\"stylesheet\" href=\"jqueryui/css/redmond/jquery-ui.theme.min.css\" />\n";
		echo "	<script src=\"jqueryui/js/jquery-ui.min.js?ver=1813\"></script>\n";
...
//]]>
	...
	function output_footer($quit=true)
	{
		...
		$memory_usage = mksize(get_memory_usage());
		...
		echo "	<br style=\"clear: both;\" />";
		echo "	</div>\n";
		echo "<div id=\"footer\"><p class=\"generation\">".sprintf($lang->generated_in, $totaltime, $debuglink, $querycount, $memory_usage)."</p><p class=\"powered\">Powered By <a href=\"https://mybb.com/\" target=\"_blank\" rel=\"noopener\">MyBB</a>, &copy; 2002-".COPY_YEAR." <a href=\"https://mybb.com/\" target=\"_blank\" rel=\"noopener\">MyBB Group</a>.</p></div>\n";
		if($mybb->debug_mode)
		{
			echo $db->explain;
		}
...
EOF;
	...
	function output_tab_control($tabs=array(), $observe_onload=true, $id="tabs")
	{
		...
		echo "<div class=\"container mt-3\"><ul class=\"tabs\" id=\"{$id}\">\n";
