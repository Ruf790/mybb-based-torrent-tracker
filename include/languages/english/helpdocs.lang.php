...
// helpdocs.php
$language['helpdocs'] = array
(

// Help Document 1
'd1_name' => "User Registration",
'd1_desc' => "Perks and privileges to user registration.",
'd1_document' => "Some parts of this forum may require you to be logged in and registered. Registration is free and takes a few minutes to complete.
...
// Help Document 4
'd4_name' => "Logging In and Out",
'd4_desc' => "How to login and log out.",
'd4_document' => "When you login, you set a cookie on your machine so that you can browse the forums without having to enter in your username and password each time. Logging out clears that cookie to ensure nobody else can browse the forum as you.
...
// Help Document 5
'd5_name' => "Posting a New Thread",
'd5_desc' => "Starting a new thread in a forum.",
'd5_document' => "When you go to a forum you are interested in and you wish to create a new thread (or topic), simply choose the button at the top and bottom of the forums entitled \"New Thread\". Please take note that you may not have permission to post a new thread in every forum as your administrator may have restricted posting in that forum to staff or archived the forum entirely.",

// Help Document 6
'd6_name' => "Posting a Reply",
'd6_desc' => "Replying to a topic within a forum.",
'd6_document' => "During the course of your visit, you may encounter a thread to which you would like to make a reply. To do so, simply click the \"New Reply\" button at the bottom or top of the thread. Please take note that your administrator may have restricted posting to certain individuals in that particular forum.
...
// Help Document 7
'd7_name' => "MyCode",
'd7_desc' => "Learn how to use MyCode to enhance your posts.",
'd7_document' => "You can use MyCode, also known as BB Codes to add effects or formatting to your posts. MyCodes are a simplified version of HTML and is used in a similar format to HTML tags which you may already be familiar with.
