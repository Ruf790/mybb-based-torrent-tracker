...
$useravatarzz = format_avatar($CURUSER['avatar'], $CURUSER['avatardimensions']);
$ava22 = '<img class="nav-avatar" src="'.$useravatarzz['image'].'" alt="" '.$useravatarzz['width_height'].' />';


$ava222 = $useravatarzz['image']; // Извлекаем только URL изображения
      ...
      <div class="dropdown-menu dropdown-menu-end border rounded" style="width: 250px">
        <div class="row p-2">
          <div class="col align-self-center">
            ...
            <a rel="nofollow" class="dropdown-item ms-0 ps-0"
               href="<?= $BASEURL ?>/member.php?action=logout&amp;logoutkey=<?= $logoutkey; ?>">
              <i class="fa-solid fa-right-from-bracket"></i> &nbsp;&nbsp;Log Out
            </a>
          </div>
         
		 <div class="col-auto align-self-center">
            <img src="<?= $ava222 ?>" style="width: 80px;" class="rounded border" />
          </div>
